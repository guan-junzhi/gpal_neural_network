...
rm -rf workspace/dyn_calibonnx_eval_fusion_200
mkdir -p workspace/dyn_calibonnx_eval_fusion_200
CUDA_VISIBLE_DEVICES=1 python3 eval.py   --load_from /data/ai_group/workdirs/gpal_neural_network_group/airflow_workspace/detzero_one_node_traning_job_on_airflow_for_k8s_20260409_14_56_14/checkpoint/epoch=1-step=10000_checkpoint.pth   --save workspace/dyn_calibonnx_eval_fusion_200   --config configs_for_develop/dyn_fusion_eval_calib_onnx_200.yaml   --gpus 1   > workspace/dyn_calibonnx_eval_fusion_200/log.txt 2>&1
