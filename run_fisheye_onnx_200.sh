...
rm -rf workspace/dyn_onnx_eval_fisheye_200
mkdir -p workspace/dyn_onnx_eval_fisheye_200
CUDA_VISIBLE_DEVICES=0 python3 eval.py \
  ...
  --save workspace/dyn_onnx_eval_fisheye_200 \
  --config configs_for_develop/dyn_fsh_eval_onnx_200.yaml \
  --gpus 1 \
  > workspace/dyn_onnx_eval_fisheye_200/log.txt 2>&1
