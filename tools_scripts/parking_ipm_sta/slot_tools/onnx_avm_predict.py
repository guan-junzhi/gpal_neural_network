...
def parse_args():
    ...
    parser.add_argument("--img_path", default="/data/ai_group/datasets/bev_park/park_slot_model_test_data/01_mifa_new_len_1121_jiawen/2025-11-21_11-50-32-032_avm", type=str)
    ...
    parser.add_argument("--save_path", default="/data/ai_group/datasets/bev_park/01_mifa_new_len_1121_jiawen/2025-11-21_11-50-32-032_avm_20251022_int16_avm_original_float_onnx_model_res", type=str)
