...
def parse_args():
    ...
    parser.add_argument("--onnx_path", default="workspace/20251201_01_37_52_1128_slot_onnx/checkpoint/epoch=146-step=150000_checkpoint_sim.onnx", type=str)
    ...
    parser.add_argument("--save_path", default="/data/ai_group/datasets/bev_park/park_slot_jira/1114_jira/res/300w_camera_label_jx_c5_001_det_res_static_thr5_1128model_onnx", type=str)
    parser.add_argument("--save_txt", default="300w_camera_label_jx_c5_001_det_res_static_thr5_1128model_onnx", type=str)
