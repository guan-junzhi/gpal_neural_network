...
from gpal_nn.tasks.parking_ipm_sta.postprocess.heatmap_instance_p3 import HeatMap
# from gpal_nn.tasks.parking_ipm_sta.postprocess.heatmap_instance_p2 import HeatMapLut
...
def parse_args():
    ...
    parser.add_argument("--onnx_path", default="/home/jovyan/gpal_neural_network/20251201_log/20251201_int16_avm_200w_quat_1000num_original_float_model.onnx", type=str)
    ...
    parser.add_argument("--save_path", default="/data/ai_group/datasets/bev_park/park_slot_jira/jira3716/all_2025_11_22_11_51_24_avm_20251201_int16_avm_optimized_float_onnx_model_res", type=str)
...
def main(args):
    ...
    SlotDetInstance = HeatMap(768, 768)
    start = time.time()
    # SlotDetInstanceLut = HeatMapLut(768, 768)
    ...
    for avm_path in avm_path_list:
        ...
        # vertexElements = detect_avm(avm_img, img_name, onnx_mode_path, args, heatmapValue, linemapValue)
        ...
        # vertexElementsFast = SlotDetInstanceLut.doProc(heatmapValue, linemapValue)
        # vertexElements = vertexElementsFast
