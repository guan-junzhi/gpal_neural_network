...
def parse_args():
    ...
    parser.add_argument("--save_path", default="/data/ai_group/datasets/bev_park/park_slot_jira/1114_jira/res/1114_serveravm_quantized_model_200w_quantized_20251022model_bc_res_static_thr5", type=str)
    parser.add_argument("--save_txt", default="200w_quat_serveravm_det_res_static_thr5", type=str)
