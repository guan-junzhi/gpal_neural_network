...
from gpal_nn.tasks.parking_ipm_sta.losses.loss import PARKING_IPM_STALoss
...
class PARKING_IPM_STAHead(BaseHead):
    def __init__(self, global_config, task_config, loss_func=PARKING_IPM_STALoss):
        super(PARKING_IPM_STAHead, self).__init__(
