...
def decode_pred_with_score(cls_score_pred, bbox_pred=None, points_pred=None, shape_types_pred=None, num_cls=2, num_query=50, pc_range=None,
                           socre_thr=0.3):
    ...
    if shape_types_pred is not None:
        _, shape_types_pred = shape_types_pred.max(-1)
        shape_types_pred = shape_types_pred[socre_mask]

    return bbox_pred, points_pred, cls_score_pred, cls_pred, shape_types_pred
