...
from gpal_nn.tasks.driving_bev_sta.heads.maptr.utils import box_corner_to_center
from gpal_nn.tasks.driving_bev_sta.heads.maptr.attention import HorizonMultiPointDeformableAttention, DetrTransformerDecoderLayer
from gpal_nn.tasks.driving_bev_sta.heads.maptr.utils import bias_init_with_prob, get_clone_module, xavier_init
...
class MapInstanceDetectorHead(nn.Module):
    ...
    def __init__(self, global_config: GlobalConfig, task_config: BaseConfigParser, layers_config):
        ...
        self.lambda_one2many = layers_config.get("lambda_one2many", 0)
        ...
        self.decoder = MapInstanceDecoder(
            ...
            decoder_layer=DetrTransformerDecoderLayer(
                crossattention=HorizonMultiPointDeformableAttention(
                    ...
                    # batch_first=True,
                    grid_align_num=2,
                    feats_size=[[self.bev_w, self.bev_h]],
                ),
                selfattention=None,
                embed_dims=self.embed_dims,
                dropout=0.1,
