...
# from models.hat.maptr.attention import (
...
# )
from gpal_nn.models.transformers.bevformer.utils import get_clone_module, QuantStub
from gpal_nn.models.transformers.bevformer.ffn import FFN
# from hat.registry import OBJECT_REGISTRY
# from hat.utils.model_helpers import fx_wrap
from gpal_nn.models.transformers.bevformer.attention import HorizonTemporalSelfAttention, HorizonSpatialCrossAttention, HorizonMultiScaleDeformableAttention3D, HorizonMultiScaleDeformableAttention
    ...
    def get_encoder_inputs(
        ...
        for lvl, feat in enumerate(mlvl_feats):
            ...
            if self.use_cams_embeds:
                feat = torch.add(feat, cams_embeds)
            feat = torch.add(
