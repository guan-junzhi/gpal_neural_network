...
from gpal_nn.models.base_modules.voxel import BatchVoxelization
...
if __name__ == "__main__":
    centerpoint_preprocess = CenterPointPreProcess(
        pc_range=[-51.2, -51.2, -5.0, 51.2, 51.2, 3.0],
        voxel_size=[0.4, 0.4, 0.4],
        max_voxels_num=30000,
        max_points_in_voxel=20,
        norm_range=[-51.2, -51.2, -5.0, 51.2, 51.2, 3.0],
        norm_dims=[0, 1, 2],
    )
    points_lst = [torch.randn(1000, 3)]
    features, coors_batch = centerpoint_preprocess(points_lst)
