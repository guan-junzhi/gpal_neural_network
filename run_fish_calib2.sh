...
rm -rf workspace/calib_data/fisheye_200
mkdir -p workspace/calib_data/fisheye_200
CUDA_VISIBLE_DEVICES=0 python3 eval.py   --load_from /data/ai_group/workdirs/gpal_neural_network_group/airflow_workspace/detzero_one_node_traning_job_on_airflow_for_k8s_20260422_05_29_28/checkpoint/epoch=2-step=16000_checkpoint.pth   --save workspace/calib_data/fisheye_200   --config configs_for_develop/dyn_fsh_eval_calib_200.yaml   --calib_data_save_path workspace/calib_data/fisheye_200   --gpus 1   > workspace/calib_data/fisheye_200/log.txt 2>&1
