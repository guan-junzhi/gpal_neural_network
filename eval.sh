...
then
    ...
    onnx_path="workspace//20250930_06_49_06_onnx/checkpoint/epoch=1-step=11000_checkpoint_sim.onnx"
    ...
    load_from=/data/ai_group/workdirs/gpal_neural_network_group/airflow_workspace/gpal_neural_network_one_node_traning_job_on_airflow_20251103_22_07_11/checkpoint/epoch=0-step=18000_checkpoint.pth
    ...
    onnx_path=/data/ai_group/workdirs/multitask_lanenet_group/tongwang/onnx/checkpoint/epoch=0-step=18000_checkpoint_sim.onnx
