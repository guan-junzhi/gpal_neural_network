...
then
    ...
    load_from=$ENV_GPAL_NEURAL_NETWORK_AIRFLOW_WORKSPACE_ROOT/lane_detection_one_node_traning_job_on_airflow_20250918_08_58_31/checkpoint/epoch=20-step=23000_checkpoint.pth
