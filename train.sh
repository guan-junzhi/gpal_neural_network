...
then
    ...
    load_from=$ENV_GPAL_NEURAL_NETWORK_AIRFLOW_WORKSPACE_ROOT/lane_detection_one_node_traning_job_on_airflow_20250914_08_20_46/checkpoint/epoch=1-step=30000_checkpoint.pth
