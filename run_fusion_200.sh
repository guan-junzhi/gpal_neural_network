...
mkdir -p workspace/dyn_pth_eval_fusion_200
...
python3 eval.py \
  ...
  --save workspace/dyn_pth_eval_fusion_200 \
  --config configs_for_develop/dyn_fusion_eval_200.yaml \
  --gpus 8 \
  > workspace/dyn_pth_eval_fusion_200/log.txt 2>&1
